...
namespace Jira.Controllers
{
    public class TicketController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            IEnumerable<ProjectResult> projectResult = handler.GetProject();
            foreach (ProjectResult component in projectResult)
            {
                projectList.Add(new SelectListItem { Text = component.Subject, Value = component.Id.ToString() });
            }
            createTicketModel.ProjectList = projectList;
